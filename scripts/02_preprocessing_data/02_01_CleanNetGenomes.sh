...
# in hard code rather than something more automatic
set -e
...
preprocessing() {
        ...
        python 02_01_01_ParserGBK.py --file ../../genomes/gbk/NC_000913.3.gbk --org "Escherichia coli str. K-12 substr. MG1655" --get "protein_id,locus_tag,gene,product,translation" --sep "|" > ../../genomes/GCF_000005845.2_E_coli_K12_genomic.faa
        python 02_01_01_ParserGBK.py --file ../../genomes/gbk/GCF_000009645.1_ASM964v1_genomic.gbff --org "Staphylococcus aureus subsp. aureus N315" --get "protein_id,old_locus_tag,gene,product,translation" --sep "|" > ../../genomes/GCF_000009645.1_ASM964v1_S_aureus_N315_genomic.faa
        python 02_01_01_ParserGBK.py --file ../../genomes/gbk/GCF_000195955.2_ASM19595v2_genomic.gbff --org "Mycobacterium tuberculosis H37Rv" --get "protein_id,locus_tag,gene,product,translation" --sep "|" > ../../genomes/GCF_000195955.2_ASM19595v2_M_tuberculosis_H37Rv_genomic.faa
        python 02_01_01_ParserGBK.py --file ../../genomes/gbk/B_subtilis_168_GCF_000009045.1_ASM904v1_genomic.gbff --org "Bacillus subtilis subsp. subtilis str. 168" --get "protein_id,old_locus_tag,gene,product,translation" --sep "|" > ../../genomes/GCF_000009045.1_ASM904v1_B_subtilis_168_genomic.faa
        python 02_01_01_ParserGBK.py --file ../../genomes/gbk/P_aeruginosa_GCF_000006765.1_ASM676v1_genomic.gbff --org "Pseudomonas aeruginosa PAO1" --get "protein_id,locus_tag,gene,product,translation" --sep "|" > ../../genomes/GCF_000006765.1_ASM676v1_P_aeruginosa_PA01_genomic.faa
        python 02_01_01_ParserGBK.py --file ../../genomes/gbk/salmonella_enterica_serovar_LT2_RN_GCF_000006945.2_ASM694v2_genomic.gbff --org "Salmonella enterica subsp. enterica serovar Typhimurium str. LT2" --get "protein_id,locus_tag,gene,product,translation" --sep "|" > ../../genomes/GCF_000006945.2_ASM694v2_S_enterica_LT2_genomic.faa
        ...
        printf "Getting modified networks...\n"
        echo "  E.coli..."
